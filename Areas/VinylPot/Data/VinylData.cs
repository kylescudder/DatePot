...
namespace DatePot.Areas.VinylPot.Data
{
    public class VinylData : IVinylData
    {
        ...
        public Task<int> UpdateVinyl(int VinylID, string Name, string ArtistName, bool Purchased)
        {
        ...
        public async Task<int> AddVinyl(string Name, string ArtistName, bool Purchased)
        {
            DynamicParameters p = new DynamicParameters();
            p.Add("Name", Name);
            p.Add("ArtistName", ArtistName);
