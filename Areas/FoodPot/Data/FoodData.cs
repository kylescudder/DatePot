...
namespace DatePot.Areas.FoodPot.Data
{
    public class FoodData : IFoodData
    {
        ...
        public async Task<List<RestaurantList>> GetRestaurantList(int? UserGroupID)
        {
        ...
        public async Task<int> AddRestaurant(string RestaurantName, int ExpenseID, int LocationID, int? UserGroupID)
        {
            DynamicParameters p = new DynamicParameters();
            p.Add("RestaurantName", RestaurantName);
            p.Add("ExpenseID", ExpenseID);
        ...
        public async Task<List<RandomRestaurant>> GetRandomRestaurant(int WhenID, int? UserGroupID)
        {
            DynamicParameters p = new DynamicParameters();
            p.Add("WhenID", WhenID);
            p.Add("UserGroupID", UserGroupID);
